...
<p align="center">
  <strong>Computer Science @ DCU · Product Support Engineer @ Telnyx</strong>
</p>
...
A mindful note-taking PWA where your thoughts grow a living plant. Vanilla JS with gamification, AI chat, lo-fi music engine, plant DNA system, and 17+ features.

`JavaScript` `PWA` `CSS3` `IndexedDB` `Web Audio`

</td>
<td width="50%">

**[📊 NTA Data Analysis](https://github.com/KevinB2212/nta-data-analysis)**

Public transport data pipeline with React dashboard. Analyses NTA datasets for insights into Irish transit. Final Year Project.
...
**[🐚 MyShell](https://github.com/KevinB2212/myshell)**
